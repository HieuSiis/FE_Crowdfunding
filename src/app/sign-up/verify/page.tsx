...
const Verify = () => {
    ...
    // useEffect(() => {
    //     if (!user) router.replace("/sign-up")
    // }, [user, router])
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            router.push('/sign-up/congratulation')
            setTimeout(() => {
    ...
    return (
        <div className="flex md:items-center md:mt-0 mt-20 justify-center w-full md:h-screen z-20">
            ...
            <div className="bg-white dark:bg-dark-500 rounded-xl shadow-md md:py-9 py-[30px] md:px-[50px] px-5 md:space-y-5 space-y-2">
                <h2 className="md:text-2xl text-xl font-bold text-neutral-500 dark:text-whitish-500">Email Verification</h2>
                <div className='md:text-sm text-xs'>
                    <p className="text-neutral-300"> Please Enter the OTP you receive to</p>
                    <p className="font-semibold text-neutral-400 dark:text-whitish-500">{user?.email}</p>
                </div>
                ...
                <div className="flex justify-start gap-5 py-2">
                    {[0, 1, 2, 3].map((i) => (
                        <input
                            ...
                            className="no-spinner w-12 h-12 text-center border dark:border-neutral-400 dark:bg-dark-500 border-whitish-200 rounded-md text-lg focus:outline-none focus:ring-1 focus:ring-primary-500"
                        />
                    ))}
                </div>
                ...
                <div className="flex items-center gap-2 py-2">
                    <Back />
                    <a href="/sign-up" className="text-sm font-semibold text-secondary-400 hover:underline">
                        Back to register
                    </a>
                </div>
            </div>
