...
const Dashboard = () => {
    const firstCampaign = dataCampaign.createdCampaigns[0];
    return (
        <main className="lg:px-10 md:px-5">
            ...
            <div className='flex flex-col gap-[30px]'>
                ...
                <div>
                    ...
                    <div className='lg:max-w-full md:max-w-[527px] max-w-[327px] overflow-x-auto'>
                ...
                <div>
                    ...
                    <div className='lg:max-w-full md:max-w-[527px] max-w-[327px] overflow-x-auto'>
                        <div className="flex lg:grid md:grid-cols-2 lg:grid-cols-4 gap-[30px] md:pb-0 pb-4">
                            {dummyData.recent.map((c: any, i: number) => (
                                <CampaignCard key={i} {...c} />
                            ))}
                        </div>
                    </div>
